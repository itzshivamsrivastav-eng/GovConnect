...
export default function Services() {
  ...
  return (
    <DashboardLayout>
      <h1 className="font-heading text-2xl font-bold text-navy-900 mb-1">Digital Services</h1>
      <p className="text-sm text-gray-500 mb-6">
        Discover real government digital services. Applications are submitted on the official government website —
        GovConnect helps you discover and track them.
      </p>
