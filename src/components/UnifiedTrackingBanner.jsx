...
export default function UnifiedTrackingBanner({ compact = false }) {
  return (
    <div
      className={`relative overflow-hidden rounded-2xl bg-navy-900 text-white border border-navy-800 ${
      ...
      <div className="relative flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 justify-between">
        <div className="flex items-start gap-3">
          <div className="shrink-0 rounded-lg bg-white/10 p-2.5">
            <LayoutDashboard size={22} className="text-saffron-400" />
          </div>
          <div>
        ...
        <Link
          to="/applications"
          className="inline-flex items-center justify-center gap-2 shrink-0 rounded-lg bg-saffron-500 hover:bg-saffron-600 transition-colors text-navy-900 font-semibold px-4 py-2.5 min-h-[44px]"
        >
